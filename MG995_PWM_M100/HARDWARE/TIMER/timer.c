...
TIM_OC_InitTypeDef 	TIM4_CH4Handler;		//定时器3通道2句柄
...
{  
    ...
    HAL_TIM_PWM_ConfigChannel(&TIM4_Handler,&TIM4_CH4Handler,TIM_CHANNEL_4);//配置TIM3通道2
...
//		__HAL_AFIO_REMAP_TIM4_PARTIAL();		//TIM3通道引脚部分重映射使能
		...
		GPIO_Initure.Pin=GPIO_PIN_9;           	//PB5
